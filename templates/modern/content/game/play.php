...
<!--<div id="topad" class="fn-clear">
    <div class="adbox bgs fn-left">
        ...
        <div class="ad728">{{ADS_HEADER}}</div>
    </div>
</div>-->
<div id="game-col" class="fn-clear" style="margin-top:10px;">
	<div class="game-left fn-left">
		<div class="ad160 bgs fn-right"><div class="relategames fn-left">Other Games {{PLAY_SIDEBAR_WIDGETS2}}</div></div>
	...
	<div class="game-right fn-left">
		...
		<div class="ad160 bgs fn-riht"><div class="relategames fn-right">Other Games {{PLAY_SIDEBAR_WIDGETS}}</div></div>
	</div>
</div>
